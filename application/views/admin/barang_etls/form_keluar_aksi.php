            ...
            <form role="form">
              <div class="box-body">
                ...
                <div class="form-group col-xs-2">
                  ...
                  <input type="text" name="qty" class="form-control input-sm" onkeyup="checksatuan()" id="qty" placeholder="">
                </div>
                <div class="form-group col-xs-2">
                  <label for="exampleInputPassword1">Jumlah Distribusi</label>
                  <input type="text" required class="form-control input-sm" onkeyup="cekdist()" name="qty_isi"
                ...
                <div class="form-group col-xs-2">
                 ...
                 <select class="form-control select2" name="id_satuan" onchange="stn()" id="id_satuan">
             ...
             <div class="box-body">
                <div class="form-group col-xs-2">
                 <label for="exampleInputPassword1">Harga Jual Distribusi</label>
                  <input type="text" class="form-control input-sm" value="<?php echo $this->model_view->hrgjual($row->id_barang);?>" id="exampleInputEmail1" name="harga_jual" placeholder="">
                </div>
