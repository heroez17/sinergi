<?php
        ...
        <small>  <a href="<?php echo base_url()?>index.php/admin/supplier/tambah/0" class="btn btn-primary" ><i class="fa fa-plus" ></i> Tambah</a></small>
            ...
            <div class="box-body table-responsive">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $row->phone.' / '.$row->email ?></td>
                  <td><?php echo $row->stts ?></td>
                  <td>
                   <span>
            <a href="#" class="glyphicon glyphicon-trash delete-personil" style="color:red"  title=""
            data-toggle="modal" data-target="#delete" 
            data-id_pr2="<?php echo $row->id_supplier;?>"
             data-nama_pr2="<?php echo $row->nama;?>" 
             ></a> 
            </span>||</span>
            <a href="<?php echo base_url()?>index.php/admin/supplier/tambah/<?php echo $row->id_supplier?>" class="glyphicon glyphicon-pencil edit-personil"
...
<div class="modal fade" id="editt" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form class="form" action="<?php echo base_url()?>index.php/admin/supplier/updatesupplier" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" style="color:red" id="myModalLabel">DELETE supplier !!!</h4>
      </div>
      <div class="modal-bodydelete">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form class="form" action="<?php echo base_url()?>index.php/admin/supplier/deletesupplier" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
