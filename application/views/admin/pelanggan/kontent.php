<?php
        ...
        <small>  <a href="<?php echo base_url()?>index.php/admin/pelanggan/tambah/0" class="btn btn-primary" ><i class="fa fa-plus" ></i> Tambah</a></small>
...
<div class="box">
            ...
            <a href="<?php echo base_url()?>index.php/admin/pelanggan/tambah/<?php echo $row->nik?>" class="glyphicon glyphicon-pencil edit-personil"
...
<div class="modal fade" id="editt" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form class="form" action="<?php echo base_url()?>index.php/admin/pelanggan/updatepelanggan" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" style="color:red" id="myModalLabel">DELETE pelanggan !!!</h4>
      </div>
      <div class="modal-bodydelete">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form class="form" action="<?php echo base_url()?>index.php/admin/pelanggan/deletepelanggan" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
