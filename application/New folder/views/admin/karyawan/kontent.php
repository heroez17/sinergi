<?php
        ...
        <small>  <a href="<?php echo base_url()?>index.php/admin/karyawan/tambah/0" class="btn btn-primary" ><i class="fa fa-plus" ></i> Tambah</a></small>
...
<div class="box">
            ...
            <a href="<?php echo base_url()?>index.php/admin/karyawan/tambah/<?php echo $row->nik?>" class="glyphicon glyphicon-pencil edit-personil"
    ...
    <div class="modal-content">
      ...
      <div class="modal-bodydelete">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form class="form" action="<?php echo base_url()?>index.php/admin/karyawan/deletekaryawan" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
