...
function buka_form(){
	var id= "0";
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/jadi/buka_form/0')?>",
                        data: 'id='+id, 
						beforeSend : function(){
	...
	var id= $('#text_cari').val();
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/jadi/cari')?>",
                        data: 'id='+id, 
						beforeSend : function(){
...
function page_detail(data){
	var id= data;
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/jadi/detail_data')?>",
                        data: 'id='+id, 
						beforeSend : function(){
    ...
    <div class="modal-content">
      ...
      <div class="modal-bodydelete">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form class="form" action="<?php echo base_url()?>index.php/admin/jadi/deletejadi" method="post">
              <div class="box-body">
