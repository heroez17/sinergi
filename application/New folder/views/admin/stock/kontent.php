<?php
         ...
         <small>  <a href="<?php echo base_url()?>index.php/admin/stock" class="btn btn-primary" ><i class="fa fa-home" ></i> Home</a></small>
         <small>  <a data-toggle="modal" data-target="#delete"  href="#" class="btn btn-primary" ><i class="glyphicon glyphicon-send" ></i> Input Pengeluaran</a></small>
