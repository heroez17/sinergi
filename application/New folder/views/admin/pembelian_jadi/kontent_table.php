...
function buka_form(data){
	var id= data;
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/pembelian_jadi/buka_form')?>",
                        data: 'id='+id, 
						beforeSend : function(){
  ...
  function pilih_pemasok(){
	  var id= $('#id_dasar').val();
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/pembelian_jadi/pilih_pemasok')?>",
                        data: 'id='+id, 
						beforeSend : function(){
	 ...
	 function simpanDetail(){
	  ...
	  if(!harga){$('#harga').focus();return false;}
	   if(!qty){$('#qty').focus();return false;}
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/pembelian_jadi/simpanDetail')?>",
	  ...
	  var id_pembelian= id_pembelian;
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/pembelian_jadi/CanceDetail')?>",
	  ...
	  var id_pembelian= id_pembelian;
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/pembelian_jadi/CanceDetail_all')?>",
 ...
 <?php foreach($cari->result() as $row){
	 if($row->stts=="PROSES"){
		 ...
		 $kirim=base_url().'index.php/admin/pembelian_jadi/kirim/'.$row->id_pembelian;
 ...
 <section class="invoice">
	 ...
	 ?>
            <tr>
              ...
              <td><?php $this->db->where('id_jadi',$row->dasar);
			  $cr = $this->db->get('tab_jadi');
			  foreach($cr->result() as $crow){
				  echo $crow->nama;
				  }?></td>
              <td><?php $this->db->where('id_pemasok',$row->id_pemasok);
			  $crss = $this->db->get('tab_pemasok_jadi');
