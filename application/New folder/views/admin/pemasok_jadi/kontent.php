...
function jmlhdata(){
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/pemasok_jadi/limitpage')?>",
                        data: 'id='+id, 
						beforeSend : function(){
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/pemasok_jadi/caripage')?>",
                        data: 'id='+id, 
						beforeSend : function(){
...
function GetDDetail(data){
	var id = data;
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/pemasok_jadi/caripagedetail')?>",
                        data: 'id='+id, 
						beforeSend : function(){
	...
	var stts = stts;
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/pemasok_jadi/caripagedetail_non')?>",
	...
	var id_dasar = $("#id_dasar").val();
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/pemasok_jadi/caripagedetail_simpan')?>",
...
function DeleteDetail(id_detail,id_pemasok){
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/pemasok_jadi/DeleteDetail')?>",
...
function bukaform(){
	var id = "0";
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/pemasok_jadi/bukapagedetail')?>",
                        data: 'id='+id, 
						beforeSend : function(){
...
<?php
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="<?php echo base_url()?>index.php/admin/pemasok_jadi" class="btn btn-primary margin-bottom"><i class="fa fa-home"></i></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
    <form class="form" action="<?php echo base_url()?>index.php/admin/pemasok_jadi/simpan" method="post">
              <div class="box-body">
