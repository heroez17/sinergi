...
function buka_form(){
	var id= "0";
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/satuan/buka_form/0')?>",
                        data: 'id='+id, 
						beforeSend : function(){
	...
	var id= $('#text_cari').val();
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/satuan/cari')?>",
                        data: 'id='+id, 
						beforeSend : function(){
...
function page_detail(data){
	var id= data;
		...
		$.ajax({
                        type: "POST",
                        url : "<?php echo base_url('index.php/admin/satuan/detail_data')?>",
                        data: 'id='+id, 
						beforeSend : function(){
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked" id="cari_text">
               <?php 
                ...
                <li><a href="#" onclick="page_detail('<?php echo $row_master->id_satuan?>')"><i class="fa fa-file-text-o"></i> <?php echo $row_master->nama?></a></li>
                <?php } ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="color:red" id="myModalLabel">RUBAH STATUS SATUAN !!!</h4>
      </div>
      <div class="modal-bodydelete">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form class="form" action="<?php echo base_url()?>index.php/admin/satuan/deletesatuan" method="post">
              <div class="box-body">
