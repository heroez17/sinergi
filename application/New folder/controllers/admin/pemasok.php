...
class Pemasok extends CI_Controller {
    ...
    , tab_dasar.nama
FROM
    ibenk_pantri.tab_pemasok_detail
...
FROM
    ...
    INNER JOIN ibenk_pantri.tab_dasar 
		...
		$userinput=$this->session->userdata('nip');
		$tglinput=date('Y-m-d');
		$this->db->query("UPDATE ibenk_pantri.tab_pemasok_detail 
	SET 
...
public function caripagedetail_simpan(){
		...
		$userinput=$this->session->userdata('nip');
		$tglinput=date('Y-m-d');
		$this->db->query("INSERT INTO ibenk_pantri.tab_pemasok_detail 
	(id_pemasok, 
	id_pemasok_detail, 
	id_dasar, 
	userinput, 
...
FROM
	...
	if(!$nok){
		...
		$this->db->query("INSERT INTO ibenk_pantri.tab_pemasok 
	(id_pemasok, 
	nama, 
	userinput, 
	userupdate, 
...
");
		$this->session->set_flashdata('info','Data Sukses Di Tambah');
			...
			$this->db->query("
UPDATE ibenk_pantri.tab_pemasok 
	SET
