		...
		public function po_keluar()
{
			...
			echo "INSERT INTO ibenk_pantri.tab_pengeluaran VALUES
				('', '$userinput', '$tglinput', '', '', '', '$rob->id_dasar','$qtykeluar', 'AKTIF', '$idpo','$id_po_det'
				)";
				echo "<p></p>";
			
				echo "select * from tab_pengeluaran_jadi 
							...
							$tut=$this->db->query("select * from tab_pengeluaran_jadi 
							  ...
							  foreach($tut->result() as $tr){
								  ...
								  $idpoo=$tr->id_po;
								  echo "<p></p>";
								  echo "UPDATE tab_pengeluaran SET stts='SELESAI',qty='0' WHERE id_po='$idpoo' AND id_po_detail='$idpodet'";
								   echo "<p></p>";
								  }
